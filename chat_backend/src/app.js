...
import {
  ...
  requestLogger,
} from "./middlewares/platformSecurity.middleware.js";
...
export const createApp = () => {
  ...
  app.use(
    express.json({ limit: "5mb", type: ["application/json", "text/plain"] }),
  );
  app.use(
    express.urlencoded({ extended: false, limit: "5mb", parameterLimit: 100 }),
  );
