...
} from "../../Servicess/chat/message.services.js";
import { sendChatFile } from "../../Servicess/chat/file.services.js";
import { addChatReaction, removeChatReaction } from "../../Servicess/chat/reaction.services.js";
import {
  actorFrom,
  handleRequest,
  requireChatAdmin,
...
export const deleteConversationMessage = handleRequest(async (req, res) =>
  sendSuccess(res, "Message deleted", await deleteChatMessage({ actor: actorFrom(req), chatId: req.params.chatId, messageId: req.params.messageId })),
);
